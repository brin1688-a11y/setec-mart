        ...
        <div class="col-md-6 col-lg-5">
            ...
            <div class="bg-white shadow-sm rounded-4 p-5">
                ...
                <div class="text-center mb-4">
                    ...
                    @endif
                    <h3 class="fw-bold mt-2">@lang('site.auth.create_account')</h3>
                    <p class="text-muted">@lang('site.auth.register_subtitle')</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-semibold">@lang('site.auth.full_name')</label>
                        <input
                            type="text"
                            name="name"
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-semibold">@lang('site.auth.confirm_password')</label>
                        <input
                            type="password"
