...
Route::post('/api/chat', [\App\Http\Controllers\ChatController::class, 'handle'])
    ->name('chat.handle');

Route::get('/search/suggest', \App\Http\Controllers\SearchSuggestController::class)
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('shopper')->group(function () {
        ...
        Route::post('/orders/{order}/reorder', \App\Http\Controllers\ReorderController::class)->name('orders.reorder');
        ...
        Route::patch('/addresses/{address}/default', [\App\Http\Controllers\AddressController::class, 'makeDefault'])->name('addresses.default');
    });
